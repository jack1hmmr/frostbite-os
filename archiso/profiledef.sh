...
file_permissions=(
  ...
  ["/usr/local/bin/frostbite-install-prepare"]="0:0:755"
  ["/usr/local/bin/frostbite-installer"]="0:0:755"
  ...
  ["/etc/sway/frostbite-installer.conf"]="0:0:644"
  ["/etc/sudoers.d/10-frostbite-live"]="0:0:440"
  ["/etc/polkit-1/rules.d/49-frostbite-live-installer.rules"]="0:0:644"
)
